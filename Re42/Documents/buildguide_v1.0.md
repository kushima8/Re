...
Re42は親指で操作可能なロータリーエンコーダーを備える40％分割キーボードです。  
...
QMKにRe42のコードはまだマージされていませんのでこの[ブランチ](https://github.com/kushima8/qmk_firmware/tree/re)を使用してください。  
...
OLEDを接続していない場合は[re42_via.hex](https://github.com/kushima8/Re/blob/master/Re42/VIA/re42_via.hex)を、  
